...
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,sBAAsB;EACtB,kBAAkB;EAClB,sBAAsB;EACtB,uBAAuB;AACzB;AACA;;;EAGE,SAAS;EACT,UAAU;EACV,mBAAmB;AACrB;;AAEA;EACE,YAAY;EACZ,YAAY;AACd;;AAEA;EACE,YAAY;EACZ,sBAAsB;;EAEtB,aAAa;EACb,gCAAgC;AAClC;AACA;EACE,eAAe;AACjB;;AAEA;EACE,WAAW;EACX,qCAAqC;EACrC,aAAa;AACf;AACA;EACE,2CAA2C;AAC7C;AACA;EACE,gBAAgB;;EAEhB,aAAa;EACb,sBAAsB;EACtB,+BAA+B;EAC/B,aAAa;EACb,mBAAmB;AACrB;AACA;EACE,iBAAiB;EACjB,WAAW;EACX,YAAY;AACd;AACA;EACE,aAAa;EACb,cAAc;EACd,oBAAoB;AACtB;AACA;EACE,iBAAiB;EACjB,gBAAgB;EAChB,YAAY;EACZ,YAAY;AACd;AACA;EACE,gBAAgB;;EAEhB,aAAa;EACb,cAAc;EACd,oBAAoB;AACtB;;AAEA;EACE,aAAa;EACb,gCAAgC;;EAEhC,kCAAkC;AACpC;;AAEA;EACE,gBAAgB;EAChB,WAAW;;EAEX,aAAa;EACb,6BAA6B;AAC/B;;AAEA;EACE,aAAa;;EAEb,kCAAkC;EAClC,qCAAqC;EACrC,mBAAmB;;EAEnB,2CAA2C;AAC7C;AACA;EACE,aAAa;EACb,mBAAmB;EACnB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,mBAAmB;;EAEnB,4CAA4C;;AAE9C;AACA;EACE,2CAA2C;EAC3C,mBAAmB;EACnB,kBAAkB;EAClB,YAAY;EACZ,iBAAiB;;EAEjB,aAAa;EACb,oCAAoC;EACpC,2BAA2B;;EAE3B,eAAe;AACjB;AACA;EACE,gBAAgB;EAChB,iBAAiB;EACjB,iBAAiB;EACjB,kBAAkB;AACpB;AACA;EACE,gBAAgB;EAChB,mBAAmB;AACrB;AACA;EACE,gBAAgB;AAClB;AACA;EACE,aAAa;EACb,kBAAkB;;EAElB,WAAW;EACX,YAAY;EACZ,eAAe;;EAEf,mBAAmB;EACnB,yBAAyB;;EAEzB,2BAA2B;AAC7B;AACA;EACE,0BAA0B;AAC5B","sourcesContent":[":root {\n  --accentColor: #ff3d2a;\n  --bgColor: #0f172a;\n  --borderColor: #2c3750;\n  --sidebarColor: #090e1a;\n}\n*,\n*::before,\n*::after {\n  margin: 0;\n  padding: 0;\n  box-sizing: inherit;\n}\n\nhtml {\n  height: 100%;\n  color: white;\n}\n\nbody {\n  height: 100%;\n  box-sizing: border-box;\n\n  display: grid;\n  grid-template-columns: 275px 1fr;\n}\nbutton {\n  cursor: pointer;\n}\n\n#side-bar {\n  width: 100%;\n  background-color: var(--sidebarColor);\n  padding: 30px;\n}\n#side-bar h1 {\n  border-bottom: 3px solid var(--borderColor);\n}\n#side-bar #add-task {\n  margin-top: 20px;\n\n  display: grid;\n  grid-auto-flow: column;\n  grid-template-columns: 35px 1fr;\n  grid-gap: 5px;\n  align-items: center;\n}\n#side-bar img {\n  filter: invert(1);\n  width: 30px;\n  height: auto;\n}\n#side-bar #navContainer {\n  display: grid;\n  grid-gap: 10px;\n  justify-items: start;\n}\n#side-bar button {\n  font-size: larger;\n  background: none;\n  color: white;\n  border: none;\n}\n#side-bar #categoryContainer {\n  margin-top: 25px;\n\n  display: grid;\n  grid-gap: 10px;\n  justify-items: start;\n}\n\n#page-wrapper {\n  display: grid;\n  background-color: var(--bgColor);\n\n  grid-template-columns: 1fr 5fr 1fr;\n}\n\n#tabWrapper {\n  grid-column: 2/3;\n  width: 100%;\n\n  display: grid;\n  grid-template-rows: 150px 1fr;\n}\n\n#tabHeader {\n  display: grid;\n\n  grid-template-rows: repeat(3, 1fr);\n  grid-template-columns: repeat(3, 1fr);\n  align-items: center;\n\n  border-bottom: 1px solid var(--borderColor);\n}\n#tabHeader h2 {\n  grid-row: 3/4;\n  white-space: nowrap;\n  justify-self: start;\n}\n\n#listWrapper {\n  display: grid;\n  grid-auto-flow: row;\n\n  grid-template-rows: repeat(auto-fill, 110px);\n\n}\n#listWrapper .item-wrapper {\n  border-bottom: 1px solid var(--borderColor);\n  padding-right: 20px;\n  align-self: center;\n  height: 100%;\n  padding-top: 15px;\n\n  display: grid;\n  grid-template-columns: 40px 1fr 40px;\n  grid-template-rows: 1fr 3fr;\n\n  cursor: pointer;\n}\n#listWrapper .item-wrapper .title {\n  grid-column: 2/3;\n  font-size: larger;\n  font-weight: bold;\n  font-style: italic;\n}\n#listWrapper .item-wrapper .desc {\n  grid-column: 2/3;\n  white-space: nowrap;\n}\n#listWrapper .item-wrapper .dueDate {\n  grid-column: 3/4;\n}\n#listWrapper .item-wrapper .completed {\n  grid-row: 1/2;\n  place-self: center;\n\n  width: 20px;\n  height: 20px;\n  cursor: pointer;\n\n  border-radius: 100%;\n  border: 2px solid #ff3d2a;\n\n  background-color: #ff15003f;\n}\n#listWrapper .item-wrapper .completed:active {\n  transform: translateY(2px);\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/intlFormatDistance.mjs");
...
class Display {
    ...
    for (const [key, value] of Object.entries(itemObj)) {
      if (key === 'prio') {
        ...
        itemPart.addEventListener('click', () => {
          ...
          const newObj = new _category_js__WEBPACK_IMPORTED_MODULE_0__["default"](tempTitle, tempItems);
  ...
  static getFormattedDueDate(item) {
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.intlFormatDistance)(item.dueDate, Date.now());
  }
    ...
    const addCategoryBtnClickHandler = () => {
      ...
      document
        ...
        .addEventListener('keydown', (event) => {
          if (event.key === 'Enter') {
            new _category_js__WEBPACK_IMPORTED_MODULE_0__["default"](event.target.value, {});
            this.render();
          }
        });
    ...
    function taskCreatePopup(event) {
      if (event.target.id === 'closed') {
        ...
        <form id="addTaskForm" method="dialog">
          ...
          <input type="date" name="due-date" class="due-date" required="" value="${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(
            new Date(),
            'yyyy-MM-dd'
          )}" min="${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(new Date(), 'yyyy-MM-dd')}">
        ...
        document.querySelector('.add').addEventListener('click', () => {
          ...
          const category = new _category_js__WEBPACK_IMPORTED_MODULE_0__["default"](retrievedCategory.title);
          category.items = retrievedCategory.items;

          category.addItem(new _item_js__WEBPACK_IMPORTED_MODULE_1__["default"](...itemData));
...
class ItemLogic {
  ...
  static tasksOverdue() {
    ...
    for (let i = 0; i < localStorage.length; ++i) {
      const currentCategory = this.getCategorybyIndex(i);
      for (let item in currentCategory.items) {
        if ((0,date_fns__WEBPACK_IMPORTED_MODULE_4__.isBefore)(currentCategory.items[item].dueDate, Date.now() + 10)) {
  ...
  static tasksDueToday() {
    ...
    for (let i = 0; i < localStorage.length; ++i) {
      const currentCategory = this.getCategorybyIndex(i);
      for (let item in currentCategory.items) {
        if ((0,date_fns__WEBPACK_IMPORTED_MODULE_5__.isToday)(currentCategory.items[item].dueDate)) {
...
/* harmony export */ });
/* harmony import */ var _getQuarter_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./getQuarter.mjs */ "./node_modules/date-fns/getQuarter.mjs");
/* harmony import */ var _toDate_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./toDate.mjs */ "./node_modules/date-fns/toDate.mjs");
...
function differenceInCalendarWeeks(dateLeft, dateRight, options) {
  ...
  const timestampLeft =
    +startOfWeekLeft - (0,_lib_getTimezoneOffsetInMilliseconds_mjs__WEBPACK_IMPORTED_MODULE_1__.getTimezoneOffsetInMilliseconds)(startOfWeekLeft);
  const timestampRight =
    +startOfWeekRight - (0,_lib_getTimezoneOffsetInMilliseconds_mjs__WEBPACK_IMPORTED_MODULE_1__.getTimezoneOffsetInMilliseconds)(startOfWeekRight);
...
/* harmony export */ });
/* harmony import */ var _constants_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./constants.mjs */ "./node_modules/date-fns/constants.mjs");
/* harmony import */ var _differenceInCalendarDays_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./differenceInCalendarDays.mjs */ "./node_modules/date-fns/differenceInCalendarDays.mjs");
/* harmony import */ var _differenceInCalendarMonths_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./differenceInCalendarMonths.mjs */ "./node_modules/date-fns/differenceInCalendarMonths.mjs");
/* harmony import */ var _differenceInCalendarQuarters_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./differenceInCalendarQuarters.mjs */ "./node_modules/date-fns/differenceInCalendarQuarters.mjs");
/* harmony import */ var _differenceInCalendarWeeks_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./differenceInCalendarWeeks.mjs */ "./node_modules/date-fns/differenceInCalendarWeeks.mjs");
/* harmony import */ var _differenceInCalendarYears_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./differenceInCalendarYears.mjs */ "./node_modules/date-fns/differenceInCalendarYears.mjs");
/* harmony import */ var _differenceInHours_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./differenceInHours.mjs */ "./node_modules/date-fns/differenceInHours.mjs");
/* harmony import */ var _differenceInMinutes_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./differenceInMinutes.mjs */ "./node_modules/date-fns/differenceInMinutes.mjs");
/* harmony import */ var _differenceInSeconds_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./differenceInSeconds.mjs */ "./node_modules/date-fns/differenceInSeconds.mjs");
/* harmony import */ var _toDate_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./toDate.mjs */ "./node_modules/date-fns/toDate.mjs");
...
function intlFormatDistance(date, baseDate, options) {
  let value = 0;
  let unit;
  const dateLeft = (0,_toDate_mjs__WEBPACK_IMPORTED_MODULE_0__.toDate)(date);
  const dateRight = (0,_toDate_mjs__WEBPACK_IMPORTED_MODULE_0__.toDate)(baseDate);

  if (!options?.unit) {
    // Get the unit based on diffInSeconds calculations if no unit is specified
    const diffInSeconds = (0,_differenceInSeconds_mjs__WEBPACK_IMPORTED_MODULE_1__.differenceInSeconds)(dateLeft, dateRight); // The smallest unit

    if (Math.abs(diffInSeconds) < _constants_mjs__WEBPACK_IMPORTED_MODULE_2__.secondsInMinute) {
      value = (0,_differenceInSeconds_mjs__WEBPACK_IMPORTED_MODULE_1__.differenceInSeconds)(dateLeft, dateRight);
      unit = "second";
    } else if (Math.abs(diffInSeconds) < _constants_mjs__WEBPACK_IMPORTED_MODULE_2__.secondsInHour) {
      value = (0,_differenceInMinutes_mjs__WEBPACK_IMPORTED_MODULE_3__.differenceInMinutes)(dateLeft, dateRight);
      unit = "minute";
    } else if (
      Math.abs(diffInSeconds) < _constants_mjs__WEBPACK_IMPORTED_MODULE_2__.secondsInDay &&
      Math.abs((0,_differenceInCalendarDays_mjs__WEBPACK_IMPORTED_MODULE_4__.differenceInCalendarDays)(dateLeft, dateRight)) < 1
    ) {
      value = (0,_differenceInHours_mjs__WEBPACK_IMPORTED_MODULE_5__.differenceInHours)(dateLeft, dateRight);
      unit = "hour";
    } else if (
      Math.abs(diffInSeconds) < _constants_mjs__WEBPACK_IMPORTED_MODULE_2__.secondsInWeek &&
      (value = (0,_differenceInCalendarDays_mjs__WEBPACK_IMPORTED_MODULE_4__.differenceInCalendarDays)(dateLeft, dateRight)) &&
      Math.abs(value) < 7
    ) {
      unit = "day";
    } else if (Math.abs(diffInSeconds) < _constants_mjs__WEBPACK_IMPORTED_MODULE_2__.secondsInMonth) {
      value = (0,_differenceInCalendarWeeks_mjs__WEBPACK_IMPORTED_MODULE_6__.differenceInCalendarWeeks)(dateLeft, dateRight);
      unit = "week";
    } else if (Math.abs(diffInSeconds) < _constants_mjs__WEBPACK_IMPORTED_MODULE_2__.secondsInQuarter) {
      value = (0,_differenceInCalendarMonths_mjs__WEBPACK_IMPORTED_MODULE_7__.differenceInCalendarMonths)(dateLeft, dateRight);
      unit = "month";
    } else if (Math.abs(diffInSeconds) < _constants_mjs__WEBPACK_IMPORTED_MODULE_2__.secondsInYear) {
      if ((0,_differenceInCalendarQuarters_mjs__WEBPACK_IMPORTED_MODULE_8__.differenceInCalendarQuarters)(dateLeft, dateRight) < 4) {
        // To filter out cases that are less than a year but match 4 quarters
        value = (0,_differenceInCalendarQuarters_mjs__WEBPACK_IMPORTED_MODULE_8__.differenceInCalendarQuarters)(dateLeft, dateRight);
        unit = "quarter";
      } else {
        value = (0,_differenceInCalendarYears_mjs__WEBPACK_IMPORTED_MODULE_9__.differenceInCalendarYears)(dateLeft, dateRight);
        unit = "year";
      }
    } else {
      value = (0,_differenceInCalendarYears_mjs__WEBPACK_IMPORTED_MODULE_9__.differenceInCalendarYears)(dateLeft, dateRight);
...
if (localStorage.length <= 0) {
  const exampleTask = new _item_js__WEBPACK_IMPORTED_MODULE_1__["default"](
    'example Task!',
    "(you can't remove this task...)",
    Date.now(),
    2
  );
  const exampleCategory = new _category_js__WEBPACK_IMPORTED_MODULE_2__["default"]('Default', { exampleTask });
  _display_js__WEBPACK_IMPORTED_MODULE_3__["default"].render(exampleCategory);
} else {
  _display_js__WEBPACK_IMPORTED_MODULE_3__["default"].render(JSON.parse(localStorage[localStorage.key(0)]));
}
